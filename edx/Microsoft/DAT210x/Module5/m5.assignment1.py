...
def doKMeans(dataframe):
  ...
  ax.scatter(dataframe.Longitude, dataframe.Latitude, marker='.', alpha=0.3)
  plt.show()
...
#
df = pd.read_csv("C:/Users/jbennett02/Documents/Magic Briefcase/classwork/edx/Microsoft/DAT210x/Module5/Datasets/Crimes_-_2001_to_present.csv",
header=0)
